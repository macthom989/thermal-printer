...
import { StrikethroughText, TextBold, TextFontA, TextFontB, TextFontC, TextItalic, TextUnderline1DotThick, TextUnderline2DotsThick } from "@/components/thermal-printer.character";
...
export const testStrikethroughTemplate = (base64Image?: string) => {
    return (
        <ThermalPrinter {...DEFAULT_PRINTER_CONFIG}>
            <Row left="Món hàng A nó rất là dài dài dài dài dài Món hàng A nó rất là dài dài dài dài dài Món hàng A nó rất là dài dài dài dài dài" right="$200.000"/>
